...
while True:
    for tapahtuma in pygame.event.get():
        if tapahtuma.type == pygame.KEYDOWN:
            ...
            #ROBO2
            if tapahtuma.key == pygame.K_a and x2 > 0:
                x2 -= 10
            if tapahtuma.key == pygame.K_d and x2 < 640-robo.get_width():
                x2 += 10
            if tapahtuma.key == pygame.K_w and y2 > 0:
                y2 -= 10
            if tapahtuma.key == pygame.K_s and y2 < 480-robo.get_height():
                y2 += 10
